...
-- 3. Identify which order statuses should be included in subsequent customer and sales analyses.
...
-- 1. Only 'delivered' orders will be retained for subsequent customers and sales analysis, as they reflect genuine customer behavior and realized revenue.
...
-- 3. Although this verification includes freight value in the total order amount, subsequent customer and sales analyses will exclude freight to focus on true product sales revenue.
